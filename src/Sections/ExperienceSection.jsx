  ...
  return (
    ...
    >
      ...
      <div className="pl-8 mb-4">
        ...
        <li>
          Implemented and enforced a new style theme in addition to the creation
          of a component library complete with Storybook visualization.
        </li>
        <li>
          Lead development of new landing page feature, working with product and
          design to define work, create and manage tickets, and coordinate work
          among the FE team.
        </li>
        <li>
      ...
      <div className="pl-8">
        <li>
          Contributed to an internal dashboard tool for a small group of senior
          level users at Starbucks as well as a dashboard for the users of a
          large-scale, fulfillment solutions application.
        </li>
        <li>
          Produced search, sorting, and product detail features for a biomedical
